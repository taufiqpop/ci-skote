            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        ...
                        <h4 class="text-uppercase">Anda tidak memiliki akses ke halaman yang anda tuju</h4>
                        <div class="mt-5 text-center">
                            <a class="btn btn-primary waves-effect waves-light" href="<?= $beranda ?>">Kembali ke beranda</a>
                        </div>
                    </div>
                </div>
            </div>
